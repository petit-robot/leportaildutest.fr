...
1. add markdown files to the `content/directory` folder. All markdown files will be automatically loaded as listings.
2. You must specify required properties of a listing such as title and description in the [frontmatter]() of the file

### Using json listings:
1. add a single json file: `content/directory/directory.json`
...
### Using csv listings:
1. add a single csv file: `content/directory/directory.csv`
...
+ Customize the `src/config/settings.toml` to your preferences.
